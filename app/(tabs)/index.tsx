...
export default function BoardScreen() {
  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: '#344B61' }}>
      {/* Header */}
      <View style={{ paddingHorizontal: 16, paddingTop: 12, paddingBottom: 8, gap: 10 }}>
          ...
          {(['yesterday', 'today', 'tomorrow'] as DateTab[]).map(dt => (
            <TouchableOpacity
              ...
              style={{
                ...
                paddingVertical: 8,
                borderRadius: 10,
                backgroundColor: dateTab === dt ? '#ffffff' : '#253548',
                borderWidth: 1,
                borderColor: dateTab === dt ? '#ffffff' : '#3f5870',
              }}
            >
              <Text style={{ color: dateTab === dt ? '#344B61' : '#9ca3af', fontSize: 13, fontWeight: '600' }}>
                {DATE_LABELS[dt]}
              </Text>
        ...
        <View style={{ flexDirection: 'row', gap: 8 }}>
          <View style={{ flex: 1, flexDirection: 'row', backgroundColor: '#253548', borderRadius: 8, padding: 3 }}>
            {([['arr', 'Arrivals'], ['dep', 'Departures']] as [ViewType, string][]).map(([v, label]) => (
              ...
              >
                <Text style={{ color: view === v ? '#344B61' : '#6b7280', fontWeight: '600', fontSize: 13 }}>
                  {label}
                </Text>
              </TouchableOpacity>
            ))}
          ...
          <View style={{ flexDirection: 'row', backgroundColor: '#253548', borderRadius: 8, padding: 3 }}>
            {(['DAM', 'ALP'] as Airport[]).map(ap => (
              ...
              >
                <Text style={{ color: airport === ap ? '#344B61' : '#6b7280', fontWeight: '700', fontSize: 13 }}>
                  {ap}
                </Text>
              </TouchableOpacity>
            ))}
