...
const ar: Dict = {
  ...
  'news.title':      'أخبار هيئة الطيران المدني',
  'news.blurb':      'صور ومقاطع من الهيئة العامة للطيران المدني السوري، إلى جانب مقاطع مختارة من شركات الطيران العاملة في سوريا.',
  'news.authority':  'الهيئة العامة للطيران المدني السوري',
