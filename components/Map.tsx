...
import {
  ...
  airlineByIata as _alByIata, icaoToIata as _icaoToIata, loadGeoData,
} from '@/lib/geo-data'
/*
 * The popup and its helpers now live in lib/flight-popup, so V3 renders the SAME popup rather
 * than a poorer second one. Nothing here changed except where the code sits — see that file for
 * why only the status is parameterised.
 */
import {
  buildPopup, progressBarHtml, identityLine, fmtHm, schedToLocal, popupToLocal,
